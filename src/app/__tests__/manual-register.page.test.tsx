...
jest.mock('@/components/SelectPhoto', () => {
    return function MockSelectPhoto() {
...
jest.mock('react-icons/im', () => ({
    ImCamera: () => <div data-testid="camera-icon">Camera</div>
}))
...
describe('ManualRegister Page', () => {
    test('should export default ManualRegister component', () => {
        const ManualRegister = require('../pages/dashboard/book-registration/manual/page').default
